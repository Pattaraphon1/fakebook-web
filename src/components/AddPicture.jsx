...
function AddPicture(props) {
    ...
    return (
        <div className='flex flex-col p-2 border rounded-lg relative cursor-pointer'>
            <div className="bg-slate-100 min-h-40"
            ...
            >
                ...
                {file &&
                    <>
                        ...
                        <button className='btn btn-sm btn-circle btn-dash btn-error absolute top-1 right-0 opacity-60'
